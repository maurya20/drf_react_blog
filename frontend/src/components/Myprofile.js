...
class Myprofile extends Component {
    ...
    <div className="col bg-white"> <img src={profile.image} alt="My profile Pic"height="300px" width="300px" style={{borderRadius:"30%"}}></img></div>
    <div className="col-6 bg-white"><h5>Phone 👉 {profile.phone}</h5>
